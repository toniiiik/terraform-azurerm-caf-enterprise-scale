...
locals {
  create_duration_delay = {
    ...
    after_azurerm_policy_exemption      = var.create_duration_delay["azurerm_policy_exemption"]
  ...
  destroy_duration_delay = {
    ...
    after_azurerm_policy_exemption      = var.destroy_duration_delay["azurerm_policy_exemption"]
